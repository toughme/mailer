  ...
  return {
    async list() {
      ...
      return rows.map((row) => ({
        ...
        hasOAuth: Boolean(row.oauth_refresh_token || row.oauth_access_token),
      ...
      try {
        await db.run(
          `INSERT INTO accounts
           (provider, primary_protocol, email, display_name, username, encrypted_password, host, port, secure, proxy_profile_id, notes, updated_at)
